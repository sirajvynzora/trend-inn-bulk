...
urlpatterns = [
    ...
    path("dashboard/products/<int:pk>/attributes/", views.product_attributes_json, name="product_attributes_json"),
    path("dashboard/products/<int:pk>/attributes/save/", views.product_attributes_save, name="product_attributes_save"),
